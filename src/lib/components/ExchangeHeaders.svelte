<script lang="ts">
    ...
    let settingsChecked:boolean;
    let settingsPopup:HTMLElement;
...
<header class="w-full h-20 pl-4 bg-[#293031] flex items-center justify-between">
    ...
    <p class="text-3xl text-white font-semibold text-center cursor-default">
        Exchange Courses
    </p>

    <div>
        {#if settingsChecked}
        <div class="-translate-x-[250%]">
