<script lang="ts">
    ...
    export let ownedCourse:string = "";
    export let ownedCourseTime:string = "";
    export let requestedCourse:string = "";
    export let requestedCourseTime:string = "";
    export let contactMethod:string = "ads";
    ...
    let pasteInit = async ()=>
        contactLink = await navigator.clipboard.readText()
</script>

<PopupTemplate title="Edit" on:cancel on:submit={async ()=>
        dispatch("submit",{
    ...
    <div class="flex flex-col w-full h-full items-center">
        ...
        <div class="w-full px-6 flex justify-between items-center">
            ...
            <div class="flex h-10 ">
                ...
                placeholder="profile link or number"
                ...
                text-black">
                <button on:click={pasteInit} class="bg-[#242526] 
